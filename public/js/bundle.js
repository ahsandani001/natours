      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Thank you for your interest! Now you can proceed to login');
              setTimeout(function () {
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGFuaXNoNzQiLCJhIjoiY2tsMGplbnhmMDRwMjJ3cWlyNHQ2OHQzZiJ9.afFTR0ziKImgPCvBLwJi1A';
...
exports.deleteTour = exports.updateSettings = void 0;
...
var stripe = Stripe('pk_test_51IMZGSIYYaetaR9vdxd6l6T59VIoWQSEk9BG58Uf6ufe4XIqbaYE6EZBjCyMTYOT0MRQsLUOAR1w8Mq5U1FRNnlP00gT9alBUK');
...
var deleteTourBtn = document.getElementById('deleteTour'); // Delegation
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 5;
              return (0, _updateSettings.deleteTour)(tourId);
